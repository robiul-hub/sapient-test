    ...
    Statement = [
      {
        ...
        Condition = {
          StringEquals = {
            "aws_iam_openid_connect_provider.oidc_provider.local.aws_iam_oidc_connect_provider_extract_from_arn:sub" : "system:serviceaccount:kube-system:cluster-autoscaler"
          }
        }
      },
    ]
